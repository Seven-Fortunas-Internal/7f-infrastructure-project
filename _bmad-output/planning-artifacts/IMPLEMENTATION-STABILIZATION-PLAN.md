...
3. [The Three-Layer Fix](#3-the-three-layer-fix)
...
#### What to Reset (regenerated by initializer on next run)

Do NOT delete manually. Let the initializer agent recreate these clean:

| Path | Regenerated by |
|------|---------------|
| `feature_list.json` | Initializer (Session 1) |
| `claude-progress.txt` | Initializer (Session 1) |
| `autonomous_build_log.md` | Initializer (Session 1) |
| `init.sh` | Initializer (Session 1) |
