...
# NFR-5.5 baseline threshold — WC-006 will raise to 75% in Sprint 5
COVERAGE_THRESHOLD = 60  # percent
...
class TestCoverageThresholdConstants:
    ...
    def test_threshold_is_60_percent(self):
        """NFR-5.5 baseline is 60%; WC-006 will raise to 75% in Sprint 5."""
        assert COVERAGE_THRESHOLD == 60, (
            f"Coverage threshold changed from 60 to {COVERAGE_THRESHOLD}. "
            "Update sprint4-plan.md P4-002 and this assertion if intentional."
        )
